...
export const Feature = () => {
  ...
  const data = [{"name":"Accuracy","value":0.8795}];
  const data2 = [{"name":"Accuracy","value":0.9336}];
  const data3 = [{"name":"Accuracy","value":0.8746}]
    ...
    return (
      <div className="px-4  bg-darkBase py-20" >
        ...
        <div className=" text-5xl ml-24 font-semibold text-white"> LPCV Pilot Locations</div>
        ...
        <div className="grid 2xl:gap-32 xl:gap-10 gap-4 justify-center row-gap-5 lg:grid-cols-3 xl:mr-32 xl:ml-32">
